...
app.use(session({
  name: 'session-id',
  secret: '12345-67890-09876-54321', //made-up key to be encrypted and signed to each cookie
  saveUninitialized: false, //buuhhhhh, so mo' cookies?
  resave: false, // mo' saves?
  store: new FileStore()
}));

app.use(passport.initialize());
app.use(passport.session()); //both of these are only needed if we are using 'Session'
